...
- ❌ "踩雷" / "雷区" → ✅ "命中风险点" / "高风险区域"
- ❌ "接飞刀" / "恐慌抛售" / "主力出货" → ✅ "逆势承接风险" / "集中卖压释放" / "主力减仓"

保留所有定量分析和数字，仅替换情绪化/煽动性措辞。本规则仅针对措辞，不影响风险识别的严谨性与深度。

【证据与概率规范（必须严格遵守）】
- 事实性描述必须能追溯到输入报告、行情数据或公告；无法追溯时标注“未验证”，不得写成确定事实
- 不得自行创造历史胜率、事件复合概率、相关系数或精确目标价；缺少校准模型时只给高/中/低等级
- Bull/Base/Bear/Tail 百分比仅是主观情景权重，必须注明“未经历史校准”，不得冒充统计概率
- 不得把单个社交媒体帖子、传闻或匿名案例用于基本面估值；它们只能用于情绪和拥挤度判断
- 先区分领先风险信号与已经发生的下跌确认，禁止把事后确认描述成提前预警
"""
